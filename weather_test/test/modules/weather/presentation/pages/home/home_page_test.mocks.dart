...
// in weather_test/test/modules/weather/presentation/pages/home/home_page_test.dart.
...
///
/// See the documentation for Mockito's code generation for more information.
class MockCacheHive extends _i1.Mock implements _i10.CacheHive {
  MockCacheHive() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<void> put(_i11.CacheModel? data) => (super.noSuchMethod(
        Invocation.method(
          #put,
          [data],
        ),
  ...
  @override
  _i4.Future<_i11.CacheModel?> get(String? id) => (super.noSuchMethod(
        Invocation.method(
          #get,
          [id],
        ),
        returnValue: _i4.Future<_i11.CacheModel?>.value(),
      ) as _i4.Future<_i11.CacheModel?>);
}
